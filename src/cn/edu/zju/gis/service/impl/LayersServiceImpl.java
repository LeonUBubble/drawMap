...
//		criteria.and
	...
	@Override
	public Layers getLayerById(Integer id) throws Exception {
		
		return layersMapper.findLayerById(id);
	}
	
	@Override
	public List<Layers> findLayersByUserID(LayersVo querylayer) throws Exception{
		return layersMapper.findLayersByUserID(querylayer);
	}
