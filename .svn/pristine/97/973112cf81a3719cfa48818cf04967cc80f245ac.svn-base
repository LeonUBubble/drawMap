...
<div id="toolPanel">
	...
	<a href="#" onclick="savemap()" title="保存地图" class="easyui-linkbutton easyui-tooltip" data-options="position:'top'" plain="true" iconCls="icon-save"></a>
...
<!-- 切换地图 -->
<!-- <div id="myChangeMap" class="changeMapWrapper"> -->
<!-- 	<div id="myMapMap" class="hoverType"> -->
<!-- 		<img src="./img/map_map.jpg"/> -->
<!-- 		地图 -->
<!-- 	</div> -->
<!-- 	<div id="myImageMap" class="hoverType"> -->
<!-- 		<img src="./img/map_image.jpg"/> -->
<!-- 		影像 -->
<!-- 	</div> -->
<!-- </div> -->
<div id="myChangeBaseMap" class="easyui-window" title="底图" style="width:200px;"
data-options="minimizable:false,
maximizable:false,
closable:false,
modal:false,
...
shadow:false">
	<div>
	    <div title="图层" style="padding:10px;">
			<ul id="baseMapTree" class="easyui-tree" onlyLeafCheck="true" dnd="true">
				<li id="0">地图</li>
				<li id="1">影像</li>
				<li id="2">清代</li>
				<li id="3">元代</li>
...
<div id="changeName" class="easyui-window" title="编辑地图属性"  align:'center' data-options="modal:true,resizable:false,closed:true">
	<div>
...
<div id="layerPanel" class="easyui-window" title="添加图层" style="width:800px;height:500px" data-options="modal:true,resizable:false,closed:true">
	...
	<div id="searchPanel" style="width: 98%;height: 30%;margin: 1%">
		<form id="searchFrom" action="#" onsubmit="return false">
			...
			<input id="searchBtn" class="btn btn-primary" type="submit" value="搜索" onclick="javascript:getLayerData(0,10)">
		</form>
...
<div style="width: 100%;">
	...
	<ul class="pagination">
    <li><a href="javascript:getLayerData(0,10)">&laquo;</a></li>
    <li><a id="li2" >上一页</a></li>
    <li><a id="li3">下一页</a></li>
    <li><a id="li4">&raquo;</a></li>
</ul>
	<button id="addBtn" class="btn btn-primary" onclick="addLayerToMap()">确定</button>
</div>
</div>
</div>
...
<!-- ============== 点选查询结果返回框  ============== -->
<div id="QueryBoard" class="easyui-window" style="width:600px" title="查询结果" data-options="closed:true">
...
<div id="res" class="ol-popupcontent">
<strong>查询结果</strong>
</div>
</div>


<div id="DetailInfoPanel" class="easyui-window" style="width:400px" title="详细信息" data-options="closed:true">
